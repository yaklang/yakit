...
module.exports = (win, getMITMClient,getReplacerApiClient,getExtractedDataApiClient,getFilterApiClient) => {
    let stream;
    let currentPort;
    let currentHost;
    ...
    const asyncDownloadMITMCert = (params) => {
        return new Promise((resolve, reject) => {
            getMITMClient().DownloadMITMCert(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncGetCurrentRules = (params) => {
        return new Promise((resolve, reject) => {
            getMITMClient().GetCurrentRules(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncSetCurrentRules = (params) => {
        return new Promise((resolve, reject) => {
            getMITMClient().SetCurrentRules(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncExportMITMReplacerRules = (params) => {
        return new Promise((resolve, reject) => {
            getReplacerApiClient().ExportMITMReplacerRules(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncImportMITMReplacerRules = (params) => {
        return new Promise((resolve, reject) => {
            getReplacerApiClient().ImportMITMReplacerRules(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    // MITMExtractedDataApi
    // asyncQueryMITMRuleExtractedData wrapper
    const asyncQueryMITMRuleExtractedData = (params) => {
        return new Promise((resolve, reject) => {
            getExtractedDataApiClient().QueryMITMRuleExtractedData(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncSetMITMFilter = (params) => {
        return new Promise((resolve, reject) => {
            getFilterApiClient().SetMITMFilter(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
    ...
    const asyncGetMITMFilter = (params) => {
        return new Promise((resolve, reject) => {
            getFilterApiClient().GetMITMFilter(params, (err, data) => {
                if (err) {
                    reject(err)
                    return
                }
