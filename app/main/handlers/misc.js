...
module.exports = (win, getClient) => {
  ...
  ipcMain.handle('cancel-RequestYakURL', async (e, token) => {
  ...
  ipcMain.handle('RequestYakURL', async (e, params, token) => {
    return await asyncRequestYakURL(params, token)
  })
  ...
  const asyncGetSpaceEngineAccountStatusV2 = (params) => {
    return new Promise((resolve, reject) => {
      getClient().GetSpaceEngineAccountStatusV2(params, (err, data) => {
        if (err) {
          reject(err)
          return
        }
  ...
  ipcMain.handle('GetSpaceEngineAccountStatusV2', async (e, params) => {
