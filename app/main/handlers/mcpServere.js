...
module.exports = (win, getClient) => {
  ...
  // asyncGetMCPToolDetail wrapper
  const asyncGetMCPToolDetail = (params) => {
    return new Promise((resolve, reject) => {
      getClient().GetMCPToolDetail(params, (err, data) => {
        if (err) {
          reject(err)
          return
        }
  ...
  ipcMain.handle('GetMCPToolDetail', async (e, params) => {
    return await asyncGetMCPToolDetail(params)
  })
