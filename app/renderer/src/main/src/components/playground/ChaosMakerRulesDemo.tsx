        ...
        <div style={{ height: '100%', overflowY: 'hidden' }}>
          <DemoVirtualTable<ChaosMakerRule>
            columns={[
              ...
              {
                headerTitle: t('playground.ChaosMakerRulesDemo.rule'),
                key: 'Name',
                width: 300,
                colRender: (i) => i.NameZh || i.Name,
              },
              {
                headerTitle: t('playground.ChaosMakerRulesDemo.type'),
                key: 'RuleType',
                width: 100,
                colRender: (i) => i.RuleType,
              },
              { headerTitle: t('playground.ChaosMakerRulesDemo.cve'), key: 'CVE', width: 110, colRender: (i) => i.CVE },
              {
                headerTitle: t('playground.ChaosMakerRulesDemo.protocol'),
                key: 'Protocol',
                width: 50,
