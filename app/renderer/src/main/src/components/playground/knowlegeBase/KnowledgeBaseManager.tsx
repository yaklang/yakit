...
export const KnowledgeBaseManager: React.FC<KnowledgeBaseManagerProps> = (props) => {
  ...
  return (
    <div className={styles['knowledge-base-manager']}>
      <AutoCard
        title={t('playground.KnowledgeBaseManager.title')}
      ...
      {/* AI问答抽屉 */}
      <YakitDrawer
        title={t('playground.KnowledgeBaseManager.qaTitle', {
          name: selectedKnowledgeBase?.KnowledgeBaseName || t('playground.KnowledgeBaseManager.knowledgeBase'),
        })}
        placement="right"
        width={600}
