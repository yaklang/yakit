...
import { Tooltip, Tree, type TreeDataNode as TreeNode } from 'antd'
        ...
        <AutoCard
          ...
          title={
            <Form layout={'inline'} onSubmitCapture={(e) => e.preventDefault()}>
              <DemoItemRadioButton
                data={[
                  { value: 'packet', label: t('playground.PacketListDemo.packet') },
                  // {value: "session", label: "会话"},
                  { value: 'tcp-reassembled', label: t('playground.PacketListDemo.tcpReassembled') },
                ]}
                value={viewer}
                setValue={setViewer}
              />
          ...
          extra={
            <Form layout={'inline'} size={'small'}>
              <Form.Item>
                <YakitInput size="small" placeholder={t('YakitInput.please_enter')} />
              </Form.Item>
              <DemoItemSwitch label={t('playground.PacketListDemo.realtime')} value={realtime} setValue={setRealtime} />
