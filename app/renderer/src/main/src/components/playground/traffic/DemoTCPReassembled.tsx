  ...
  return (
    <DemoVirtualTable<TrafficTCPReassembled>
      ...
      columns={[
        ...
        { headerTitle: 'ID', key: 'id', width: 80, colRender: (i) => i.Id },
        {
          headerTitle: t('playground.DemoTCPReassembled.source'),
          key: 'source',
          width: 160,
          colRender: (i) => i.Source,
        },
        {
          headerTitle: t('playground.DemoTCPReassembled.destination'),
          key: 'destination',
          width: 160,
          colRender: (i) => i.Destination,
        },
        {
          headerTitle: t('playground.DemoTCPReassembled.protocol'),
          key: 'protocol',
          width: 160,
          colRender: (i) => i.Protocol,
        },
        {
          headerTitle: t('playground.DemoTCPReassembled.length'),
          key: 'length',
          width: 80,
