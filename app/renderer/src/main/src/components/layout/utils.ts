...
export const apiSystemConfig: APINoRequestFunc<API.SystemConfigResponse> = (hiddenError) => {
    return new Promise((resolve, reject) => {
        NetWorkApi<null, API.SystemConfigResponse>({
            ...
            .then(resolve)
            .catch((e) => {
                if (!hiddenError) yakitNotify("error", t("LayoutUtils.apiSystemConfigFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const grpcExportProject: APIFunc<ExportProjectRequest, null> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ...
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                if (!hiddenError) yakitNotify("error", t("LayoutUtils.grpcExportProjectFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const grpcCancelExportProject: APIFunc<string, null> = (token, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                if (!hiddenError) yakitNotify("error", t("LayoutUtils.grpcCancelExportProjectFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const grpcGetProjects: APIFunc<ProjectParamsProp, ProjectsResponse> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                if (!hiddenError) yakitNotify("error", t("LayoutUtils.grpcGetProjectsFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const apiSplitUpload: APIFunc<SplitUploadRequest, SplitUploadResponse> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                if (!hiddenError) yakitNotify("error", t("LayoutUtils.apiSplitUploadFailed", {error: String(e)}))
                reject(e)
            })
    })
}
