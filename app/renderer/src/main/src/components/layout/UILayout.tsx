...
const UILayout: React.FC<UILayoutProp> = (props) => {
    ...
    useEffect(() => {
        setTimeout(() => {
             ...
             */
            console.log("useEffect-SystemInfo.isDev", SystemInfo.isDev)
            if (SystemInfo.isDev) {
    ...
    const showCheckVersion = useMemo(() => {
        console.log("showCheckVersion-SystemInfo.isDev", SystemInfo.isDev, "1", builtInVersion, "1", currentVersion)
    ...
    const onLinkedEngine = useMemoizedFn(async () => {
        ...
        try {
            ...
            console.log("onLinkedEngine-SystemInfo.isDev", SystemInfo.isDev)
            if (SystemInfo.isDev) {
