...
import { MacUIOpMinSvgIcon } from '@yakit-libs/yakit-ui-icons/oldicon/MacUIOpMinSvgIcon'
import { MacUIOpRestoreSvgIcon } from '@yakit-libs/yakit-ui-icons/oldicon/MacUIOpRestoreSvgIcon'
