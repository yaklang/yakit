...
/**
 * @name yakit白底图标(可以改svg代码进行大小和底色调整)
 */
 ...
 * @name 插件商店图标
 */
export const YakitStoreSvgIcon = (props: Partial<CustomIconComponentProps>) => {
    return <Icon component={YakitStoreSvg} {...props} />
}
...
const MacUIOpCloseSvg = () => (
    <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14ZM7.03033 5.96967C6.73744 5.67678 6.26256 5.67678 5.96967 5.96967C5.67678 6.26256 5.67678 6.73744 5.96967 7.03033L6.93934 8L5.96967 8.96967C5.67678 9.26256 5.67678 9.73744 5.96967 10.0303C6.26256 10.3232 6.73744 10.3232 7.03033 10.0303L8 9.06066L8.96967 10.0303C9.26256 10.3232 9.73744 10.3232 10.0303 10.0303C10.3232 9.73744 10.3232 9.26256 10.0303 8.96967L9.06066 8L10.0303 7.03033C10.3232 6.73744 10.3232 6.26256 10.0303 5.96967C9.73744 5.67678 9.26256 5.67678 8.96967 5.96967L8 6.93934L7.03033 5.96967Z'
            fill='#F7544A'
        />
    </svg>
)
...
const MacUIOpMinSvg = () => (
    <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14ZM5.75 7.25C5.33579 7.25 5 7.58579 5 8C5 8.41421 5.33579 8.75 5.75 8.75H10.25C10.6642 8.75 11 8.41421 11 8C11 7.58579 10.6642 7.25 10.25 7.25H5.75Z'
            fill='#FFB660'
        />
    </svg>
)
...
const MacUIOpMaxSvg = () => (
    <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14ZM5.35474 5.51061C5.35127 5.42316 5.42311 5.35132 5.51056 5.35479L8.83166 5.48641C8.96235 5.49159 9.02427 5.64987 8.93179 5.74236L5.74231 8.93184C5.64982 9.02432 5.49154 8.9624 5.48636 8.83171L5.35474 5.51061ZM10.4894 10.6452C10.5769 10.6487 10.6487 10.5768 10.6453 10.4894L10.5136 7.16829C10.5085 7.0376 10.3502 6.97568 10.2577 7.06816L7.06821 10.2576C6.97573 10.3501 7.03765 10.5084 7.16834 10.5136L10.4894 10.6452Z'
            fill='#56C991'
        />
    </svg>
)
...
const MacUIOpRestoreSvg = () => (
    <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14ZM7.99353 7.8378C7.997 7.92526 7.92516 7.99709 7.83771 7.99363L4.51661 7.86201C4.38592 7.85683 4.324 7.69854 4.41648 7.60606L7.60597 4.41658C7.69845 4.32409 7.85673 4.38602 7.86191 4.5167L7.99353 7.8378ZM8.16232 8.00638C8.07486 8.00292 8.00303 8.07475 8.0065 8.1622L8.13811 11.4833C8.14329 11.614 8.30158 11.6759 8.39406 11.5834L11.5835 8.39395C11.676 8.30146 11.6141 8.14318 11.4834 8.138L8.16232 8.00638Z'
            fill='#56C991'
        />
    </svg>
)
