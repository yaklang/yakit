        ...
        return (
            <div
                className={classNames(styles["virtual-table-row-cell"], item.data["cellClassName"], {
                    ...
                    [styles["virtual-table-active-row-red"]]: isSelect && item.data["cellClassName"].indexOf("color-opacity-bg-red") !== -1,
                    [styles["virtual-table-batch-active-row"]]: batchActive,
                    [styles["virtual-table-hover-row"]]: mouseCellId === item.data[renderKey],
                    [styles["virtual-table-hover-row-red"]]: mouseCellId === item.data[renderKey] && item.data["cellClassName"].indexOf("color-opacity-bg-red") !== -1,
