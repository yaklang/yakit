...
export const WindowPositionOP: React.FC<WindowPositionOPProps> = memo((props) => {
  ...
  return (
    <div className={styles['window-position-op-wrapper']}>
      <Tooltip title={t('YakitWindow.floatWindow')}>
      ...
      <Tooltip title={t('YakitWindow.dockBottom')}>
      ...
      <Tooltip title={t('YakitWindow.dockLeft')}>
      ...
      <Tooltip title={t('YakitWindow.dockRight')}>
