    ...
    <YakitDrawer
      ...
      title={
        <div className={styles['advanced-configuration-drawer-title']}>
          <div className={styles['advanced-configuration-drawer-title-text']}>{t('YakitButton.advancedFilter')}</div>
      ...
      <div className={styles['advanced-config-wrapper']}>
        <div className={styles['config-item-wrapper']}>
          <div className={styles['item-header']}>
            <div className={styles['header-title']}>{t('YakitButton.advancedFilter')}</div>
            <YakitButton type="text" onClick={handleReset}>
              {t('YakitButton.reset')}
            </YakitButton>
          </div>

          <Form form={form} labelCol={{ span: 6 }} wrapperCol={{ span: 16 }} className={styles['filters-form']}>
            <Form.Item
              name="filterMode"
              label={
            ...
            <div style={{ display: filterModeWatch === 'shield' ? 'block' : 'none' }}>
              ...
              <Form.Item label={t('HTTPFlowTableFormConfiguration.fileExtension')} name={['shield', 'fileSuffix']}>
                <YakitSelect mode="tags"></YakitSelect>
              </Form.Item>
            ...
            <div style={{ display: filterModeWatch === 'show' ? 'block' : 'none' }}>
              ...
              <Form.Item label={t('HTTPFlowTableFormConfiguration.fileExtension')} name={['show', 'fileSuffix']}>
                <YakitSelect mode="tags"></YakitSelect>
              </Form.Item>

              <Form.Item label={t('HTTPFlowTableFormConfiguration.responseType')} name={['show', 'searchContentType']}>
                <YakitSelect mode="tags" options={contentType}></YakitSelect>
              </Form.Item>
            </div>
          </Form>
