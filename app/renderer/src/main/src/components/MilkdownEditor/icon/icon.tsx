...
const code2 = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18 16L22 12L18 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
const heading1 = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M17 12L20 10V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
/**
...
const notepadFileTypeCompress = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#576A95"
    />
    <path d="M30.3516 3V12.3984C30.3516 13.0456 30.8762 13.5703 31.5234 13.5703H40.8047L30.3516 3Z" fill="#BBC3D4" />
    <path
...
const notepadFileTypeExcel = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#00C090"
    />
    <path d="M30.3516 3V12.3984C30.3516 13.0456 30.8762 13.5703 31.5234 13.5703H40.8047L30.3516 3Z" fill="#68DBBF" />
    <path
...
const notepadFileTypePdf = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#FF4867"
    />
    <path d="M30.3516 3V12.3984C30.3516 13.0456 30.8762 13.5703 31.5234 13.5703H40.8047L30.3516 3Z" fill="#FF97A9" />
    <path
