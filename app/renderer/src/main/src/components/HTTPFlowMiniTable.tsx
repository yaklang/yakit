      ...
      columns: props.simple
        ? [
            {
              ...
              render: (i: any) => {
                ...
                return <div style={{ overflow: 'hidden' }}>{flow?.Id}</div>
              },
              width: 60,
              lock: true,
            },
                    ...
                    {flow && (
                      <Space size={4}>
                        ...
                        <Tag
                          ...
                          color={StatusCodeToColor(flow.StatusCode)}
                        >
                          {flow.StatusCode}
                        </Tag>
                      </Space>
              ...
              render: (i: any) => {
                ...
                return (
                  <div style={{ overflow: 'hidden' }}>
                    {flow && (
                      <Space>
                        <CopyableField text={flow.Url} tooltip={false} noCopy={true} />
                      </Space>
                    )}
                  </div>
                )
            ...
            {
              code: 'Hash',
              name: t('HTTPFlowMiniTable.bodyLength'),
              render: (i: any) => {
                const flow: HTTPFlow | undefined = findHTTPFlowById(i)

                return <div style={{ overflow: 'hidden' }}>{flow?.BodySizeVerbose}</div>
              },
              width: 100,
              lock: true,
            },
        ...
        : [
            ...
            },
            {
              code: 'Url',
              name: 'URL',
              render: (i: any) => <CopyableField text={i} tooltip={false} noCopy={true} />,
              width: 450,
            ...
            },
            {
              ...
              width: props.onSendToWebFuzzer ? 180 : 80,
              lock: true,
            },
          ],
    })
