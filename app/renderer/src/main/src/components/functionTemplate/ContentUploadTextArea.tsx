        ...
        item={{
          help: (
            <div className="content-upload-input-help">
              {uploadHelpText || t('YakitFormDragger.dragFileHereOr', { fileType: 'TXT' })}
              <Upload
                // accept={"text/plain"}
                multiple={false}
                maxCount={1}
                ...
                {...dragger}
              >
                <span className="help-hint-title">{t('YakitDraggerContent.click_here')}</span>
              </Upload>
    ...
    return (
      <ItemDraggerTextArea
        ...
        item={{
          help: (
            <div className="content-upload-input-help">
              {uploadHelpText || t('YakitFormDragger.dragFileHereOr', { fileType: 'TXT、Excel' })}
              <Upload
                // accept={"text/plain"}
                multiple={false}
                maxCount={1}
