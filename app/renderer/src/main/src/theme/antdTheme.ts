...
export const yakitAntdTheme: ThemeConfig = {
  ...
  token: {
    ...
    colorWhite: 'var(--Colors-Use-Main-On-Primary)',
    borderRadius: 4,
  ...
  components: {
    ...
    Switch: {
      // handleBg 默认跟 colorWhite，而 colorWhite 映射了 Main-On-Primary（橙色主题会偏粉），用纯白变量避免偏色
      handleBg: 'var(--Colors-Use-Basic-White)',
    },
    Input: {
