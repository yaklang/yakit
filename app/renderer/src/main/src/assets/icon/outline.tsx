...
const OutlineRobot = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <rect
            ...
            strokeLinejoin='round'
        />
        <path d='M1 12V16' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
        <path d='M23 12V16' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
        <path d='M12 5L12 8' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
        <circle
            cx='12'
            cy='4'
            r='1'
...
const OutlineBug = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_1_3136)'>
            ...
            <path d='M2 13H5' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M19 13H22' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path
                ...
                strokeLinecap='round'
            />
            <path d='M21 6C21 7.65685 19.6569 9 18 9' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M3 21C3 19.3431 4.34315 18 6 18' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M3 6C3 7.65685 4.34315 9 6 9' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M21 21C21 19.3431 19.6569 18 18 18' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
        </g>
    </svg>
)
/**
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_1_3058)'>
            <path
                ...
                strokeLinecap='round'
            />
            <path d='M15.5355 8.46446L8.46445 15.5355' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_1_3057)'>
            <path
                ...
                strokeLinecap='round'
            />
            <path d='M5.63623 8.46451L3.70438 7.94687' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M8.11108 5.98963L7.59345 4.05778' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M15.5356 18.3639L16.0533 20.2958' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path d='M18.0105 15.889L19.9423 16.4067' stroke='currentColor' strokeWidth='2' strokeLinecap='round' />
            <path
...
const OutlineLog2 = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <path
            ...
            strokeLinejoin='round'
        />
        <path d='M4 4V9H16' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
)
/**
