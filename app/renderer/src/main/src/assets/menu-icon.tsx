 ...
 * @Date: 2022-11-08 14:16:46
 * @LastEditors: TangHang123 1425735414@qq.com
 * @LastEditTime: 2022-11-08 14:34:27
 * @FilePath: \yakit\app\renderer\src\main\src\assets\menu-icon.tsx
 ...
 * @description:  端口扫描
 */
export const PortScanningIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:  基础爬虫
 */
export const BasicCrawlerIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const ComprehensiveCatalogScanningAndBlastingIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:  专项漏洞检测
 */
export const SpecialVulnerabilityDetectionIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:  批量漏洞检测
 */
export const BatchVulnerabilityDetectionIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:  插件仓库
 */
export const PluginWarehouseIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const MITMInteractiveHijackingIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const WebFuzzerIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const BlastingAndUnauthorizedTestingIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:Codec
 */
export const CodecIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:数据对比
 */
export const DataComparisonIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:端口监听器
 */
export const PortListenerIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:反连服务器
 */
export const ReverseConnectionServerIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:DNSLog
 */
export const DNSLogIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const ICMPSizeLogIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const TCPPortLogIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 */
export const YsoJavaHackIcon = (props: Partial<CustomIconComponentProps>) => {
 ...
 * @description:插件批量执行
 */
export const PluginBatchExecutionIcon = (props: Partial<CustomIconComponentProps>) => {
