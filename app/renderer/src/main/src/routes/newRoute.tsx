...
const ContextMenuActionExecution = React.lazy(() =>
  import('@/pages/contextMenuPlugin/ContextMenuActionExecution').then((m) => ({
    default: m.ContextMenuActionExecution,
  })),
)
const ContextMenuManager = React.lazy(() =>
  import('@/pages/contextMenuPlugin/ContextMenuManager').then((m) => ({ default: m.ContextMenuManager })),
)
