...
export const usePageNode = create<PageNodeInfoProps>()(
    subscribeWithSelector((set, get) => ({
        ...
        flatPageChildrenListAndRemoveGroupByPageGroupId: (key, pageGroupId) => {
            ...
            for (let index = 0; index < l; index++) {
                ...
                if (element.pageId === pageGroupId) {
                    ...
                    newPageNodeList = [...newPageNodeList, ...childrenList]
                } else {
        ...
        addPageNode: (key, list) => {
            ...
            const newPageNodeList: PageNodeItemProps[] = pageNodeList.filter(
                (ele) => pageChildrenList.findIndex((l) => l.pageId === ele.pageId) === -1
            )
