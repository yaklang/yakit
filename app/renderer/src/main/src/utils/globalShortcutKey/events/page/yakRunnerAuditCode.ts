...
const AuditCodeShortcutKeyEvents: EventsType = {
  'search*aduit': {
    name: 'ShortcutKey.openSearchDoubleClick',
    keys: [YakitKeyMod.Shift],
  },
  'searchTab*aduit': {
    name: 'ShortcutKey.switchSearchBar',
    keys: [YakitKeyBoard.Tab],
  },
  'searchArrowUp*aduit': {
    name: 'ShortcutKey.searchListUp',
    keys: [YakitKeyBoard.UpArrow],
  },
  'searchArrowDown*aduit': {
    name: 'ShortcutKey.searchListDown',
    keys: [YakitKeyBoard.DownArrow],
  },
  'searchEscape*aduit': {
    name: 'ShortcutKey.closeSearch',
    keys: [YakitKeyBoard.Escape],
  },
  'searchEnter*aduit': {
    name: 'ShortcutKey.searchJump',
    keys: [YakitKeyBoard.Enter],
  },
  'submit*aduit': {
    name: 'ShortcutKey.startAudit',
    ...
    .then((res) => {
      ...
      try {
        const data: EventsType = JSONParseLog(res, {
          ...
          fun: 'getStorageAuditCodeShortcutKeyEvents',
        })
