...
// import {lightColors, darkColors} from "./kuriorColors"

// export function defineKuriorThemes() {
//     monaco.editor.defineTheme("kurior-light", createTheme(lightColors, "vs"))
//     monaco.editor.defineTheme("kurior-dark", createTheme(darkColors, "vs-dark"))
// }

// function createTheme(colors: typeof lightColors, base: "vs" | "vs-dark") {
//     return {
//         base,
//         inherit: true,
//         rules: [
...
//             "editor.inactiveSelectionBackground": colors.selectionBg,
