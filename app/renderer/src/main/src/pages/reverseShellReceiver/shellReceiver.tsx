        ...
        <div className={styles['content']}>
          <YakitSpin spinning={loading}>
            {reverseShellCommand?.Status.Ok ? (
              ...
              <Result className={styles['content-result']} status="error" title={reverseShellCommand?.Status.Reason} />
            )}
          </YakitSpin>
        </div>
      )}
            ...
            content={
              <div className={styles['setting-terminal']}>
                ...
                <div className={styles['setting-terminal-size']}>
                  <div>
                    设置size:&nbsp;export TERM=xterm-256color && stty rows {xtermSize?.rows || 0} columns{' '}
