...
export const IRifyUpdateProjectManagerModal: React.FC<IRifyUpdateProjectManagerModalProps> = (props) => {
    ...
    useEffect(() => {
        ...
        ipcRenderer.on(`${token}-error`, (_, e) => {
            failed(t("ProjectManage.syncFailed", {error: e}))
        })
        return () => {
    ...
    const StopUpdate = () => {
        ...
        ipcRenderer.invoke("cancel-MigrateSSAProject", token).catch((e) => {
            failed(t("ProjectManage.stopFailed", {error: e}))
        })
    }
    return (
        <YakitModal
            ...
            <div className={styles["yaklang-engine-hint-wrapper"]}>
                ...
                <div className={styles["hint-right-wrapper"]}>
                    <div className={styles["hint-right-download"]}>
                        <div className={styles["hint-right-title"]}>{t("ProjectManage.syncingData")}</div>
                        <div className={classNames(styles["download-progress"], "yakit-progress-wrapper")}>
                            <Progress
                                ...
                                showInfo={false}
                            />
                            <div className={styles["progress-title"]}>{t("ProjectManage.progress", {percent: Math.round(percent)})}</div>
                        </div>
