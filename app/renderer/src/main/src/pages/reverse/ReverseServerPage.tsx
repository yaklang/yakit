                ...
                subTitle={
                    <Space>
                        {bridgeIP ? (
                            ...
                            >
                                公网{" "}
                                <Text strong={true} style={{color: "#229900"}} copyable={true}>
                                    {bridgeIP}
                                </Text>
                            </Tag>
                        ) : (
                        ...
                        message={
                            <Space direction={"vertical"}>
                                <Space>
                                    ...
                                    <CopyableField
                                        text={`rmi://${
                                            bridgeIP && params.ConnectParam?.Addr ? bridgeIP : "127.0.0.1"
                                        }:${params.LocalFacadePort}/${reverseToken}`}
                                    />
                                </Space>
                                <Space>
                                    本地 HTTP 反连{" "}
