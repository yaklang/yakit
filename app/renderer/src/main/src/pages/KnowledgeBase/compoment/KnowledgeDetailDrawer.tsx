...
const KnowledgeDetailDrawer: FC<KnowledgeDetailDrawerProps> = ({
    ...
    const onSubmit = async () => {
        ...
        const transformData = {
            ...knowledgeDrawerDetail,
            ...resultData,
            PotentialQuestions: resultData?.PotentialQuestions?.map((it) => it.relation),
        ...
        await ipcRenderer.invoke("UpdateKnowledgeBaseEntry", transformData).then(() => {
