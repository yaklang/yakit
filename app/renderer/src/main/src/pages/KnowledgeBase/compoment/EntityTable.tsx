...
import {apiQueryEntity, BuildingKnowledgeBaseEntry, transformToGraphData} from "../utils"
...
import {OutlinePhotographIcon, OutlinePlay2Icon, OutlineTerminalIcon} from "@/assets/icon/outline"
...
const EntityTable: FC<KnowledgeBaseTableHeaderProps & {linkId: string[]}> = (props) => {
    const {knowledgeBaseItems, setTableProps, tableProps, query, linkId, api} = props
