...
interface HoldGRPCStreamParams {
    ...
    onEnd?: (streamInfo?: HoldGRPCStreamInfo & {runtimeId?: string; loading?: boolean; requestToken?: string}) => any
    /** 数据流发生错误的回调 */
    onError?: (e: any) => void
...
export type InternalStreamStore = {
    ...
    info: HoldGRPCStreamInfo & {runtimeId?: string; loading?: boolean; requestToken?: string}
}
