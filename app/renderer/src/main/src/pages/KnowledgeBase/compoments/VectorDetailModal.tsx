...
const VectorDetailModal: FC<TVectorDetailModalProps> = ({
    vectorDetailModalData: {vectorDetailModalVisible, selectedEntryDetail},
    ...
    return (
        <YakitModal
            ...
            maskClosable={false}
            footer={[
                <div className={styles["vector-detail-modal-footer"]}>
                    <YakitButton key='close' onClick={handClose}>
                        关闭
                    </YakitButton>
                </div>
            ]}
                ...
                <div>
                    ...
                    <div className={styles["detail-grid"]}>
                        <div className={styles["detail-row"]}>
                            ...
                            <div className={styles["value"]}>{selectedEntryDetail.ID}</div>
                        </div>
                        <div className={styles["detail-row"]}>
                            <div className={styles["label"]}>UID:</div>
                            <div className={styles["value"]}>{selectedEntryDetail.UID || "无"}</div>
                        </div>
                        <div className={styles["detail-row"]}>
                        ...
                        <div className={styles["detail-section"]}>
                            <div className={styles["metadata-display"]}>
                                <div className={styles["metadata-item"]}>
                                    <div className={styles["metadata-value"]}>{selectedEntryDetail.Metadata}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className={styles["detail-section"]}>
                            {expand ? (
                                <div className={styles["vector-display"]}>
                                    {selectedEntryDetail.Embedding.map((value, index) => (
                                ...
                                <div className={styles["vector-display"]}>
                                    ...
                                    {selectedEntryDetail.Embedding.length > 20 && (
                                        <YakitButton size='small' color='blue' onClick={() => setExpand(true)}>
                                            剩余 {selectedEntryDetail.Embedding.length - 20} 维
                                        </YakitButton>
                                    )}
                                </div>
                            )}
