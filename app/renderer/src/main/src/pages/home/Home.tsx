...
const Home: React.FC<HomeProp> = (props) => {
    const {t, i18n} = useNamespace(["yakitUi", "yakitRoute", "home"])
                            ...
                            >
                                ...
                                <div className={styles["security-tools"]}>
                                    ...
                                    >
                                        ...
                                        <span className={styles["tools-text"]} title={t("portScan")}>
                                    ...
                                    >
                                        <PublicBruteIcon className={styles["tools-icon"]} />
                                        <span className={styles["tools-text"]} title={t("weakPasswordCheck")}>
                                    ...
                                    >
                                        ...
                                        <span className={styles["tools-text"]} title={t("dirBruteForce")}>
