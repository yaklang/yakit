...
const Home: React.FC<HomeProp> = (props) => {
    ...
    const [searchToolList, setSearchToolList] = useState<ToolInfo[]>([])
    ...
    return (
        <div className={styles["home-page-wrapper"]} ref={homeRef}>
            <div className={styles["home-page-wrapper-left"]}>
                <div className={styles["home-page-wrapper-left-top"]}>
                    <div
                        className={classNames(styles["mitm-card"], styles["home-card"])}
                        onClick={() => onMenu({route: YakitRoute.HTTPHacker})}
                    >
                        ...
                        <div className={styles["mitm-cont-wrapper"]} style={{backgroundImage: `url(${mitmBg})`}}>
                ...
                <div className={styles["home-page-wrapper-left-bottom"]}>
                    <div className={styles["signle-jump-wrapper"]}>
                        <div
                    ...
                    <div className={classNames(styles["vulnerability-scanning-card"], styles["home-card"])}>
                        <div className={styles["home-card-header"]}>
                            <div className={styles["home-card-header-title"]}>
            ...
            <div className={styles["home-page-wrapper-right"]}>
                ...
                <div className={styles["data-preview-wrapper"]}>
                    ...
                    <div className={styles["data-preview-item"]}>
                        ...
                        <div className={styles["data-preview-item-cont"]}>
                            {!judgeMoreTenGB ? (
                                ...
                                <>
                                    <span className={styles["data-preview-item-number"]} style={{color: "#f6544a"}}>
                                        {curProjectInfo?.FileSize}
                                    </span>
                    ...
                    <div className={styles["data-preview-item"]}>
                        ...
                        <div className={styles["data-preview-item-cont"]}>
                            <span className={styles["data-preview-item-number"]}>{portTotal}</span>
                        </div>
                    </div>
                    <div className={styles["data-preview-item"]}>
                        ...
                        <div className={styles["data-preview-item-cont"]}>
                            {localPluginTotal < 30 ? (
                                ...
                                <span className={styles["data-preview-item-number"]}>{localPluginTotal}</span>
                            )}
                        </div>
                        {visibleOnline && (
