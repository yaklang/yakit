...
export const grpcMITMStopCall: APIFunc<string, null> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmstopcall_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMHaveCurrentStream: APIFunc<string, MITMHaveCurrentStreamResponse> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmhavecurrentstream_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMRecover: APIFunc<string, null> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmrecover_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMStartCallV1: APIFunc<MITMStartCallRequestV1, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmstartcallv1_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMStartCallV2: APIFunc<MITMStartCallRequestV2, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmstartcallv2_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMExecScriptById: APIFunc<MITMExecScriptByIdRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmexecscriptbyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMRemoveHook: APIFunc<MITMRemoveHookRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmremovehook_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMResetFilter: APIFunc<string, null> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmresetfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcResetMITMFilter: APINoRequestFunc<null> = (hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_resetmitmfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMSetFilter: APIFunc<MITMSetFilterRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmsetfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMGetFilter: APINoRequestFunc<MITMFilterSchema> = (hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmgetfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMHijackSetFilter: APIFunc<MITMHijackSetFilterRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmhijacksetfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMHijackGetFilter: APINoRequestFunc<MITMFilterSchema> = (hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmhijackgetfilter_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMAutoForward: APIFunc<MITMHijackGetFilterRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmautoforward_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMDropRequestById: APIFunc<number, null> = (id, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmdroprequestbyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMDropResponseById: APIFunc<number, null> = (id, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmdropresponsebyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMForwardRequestById: APIFunc<number, null> = (id, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmforwardrequestbyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMForwardResponseById: APIFunc<number, null> = (id, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmforwardresponsebyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMHijackedCurrentResponseById: APIFunc<number, null> = (id, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmhijackedcurrentresponsebyid_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMEnablePluginMode: APIFunc<MITMEnablePluginModeRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmenablepluginmode_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMForwardModifiedRequest: APIFunc<MITMForwardModifiedRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmforwardmodifiedrequest_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMForwardModifiedResponse: APIFunc<MITMForwardModifiedResponseRequest, null> = (
  ...
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmforwardmodifiedresponse_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMExecScriptContent: APIFunc<MITMExecScriptContentRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmexecscriptcontent_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMGetCurrentHook: APIFunc<string, null> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmgetcurrenthook_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMContentReplacers: APIFunc<MITMContentReplacersRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmcontentreplacers_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMClearPluginCache: APIFunc<string, null> = (version, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmclearplugincache_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMFilterWebsocket: APIFunc<MITMFilterWebsocketRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmfilterwebsocket_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMSetDownstreamProxy: APIFunc<MITMSetDownstreamProxyRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmsetdownstreamproxy_failed') + e)
        reject(e)
      })
  })
}
...
export const grpcMITMHotPort: APIFunc<MITMHotPortRequest, null> = (params, hiddenError) => {
  return new Promise((resolve, reject) => {
    ...
    ipcRenderer
      ...
      .then(resolve)
      .catch((e) => {
        if (!hiddenError) yakitNotify('error', i18n.t('MITMHacker.grpc_mitmhotport_failed') + e)
        reject(e)
      })
  })
}
