...
const MITMFormAdvancedConfiguration: React.FC<MITMFormAdvancedConfigurationProps> = React.memo(
    React.forwardRef((props, ref) => {
        ...
        const onExportCerts = useMemoizedFn((item: ClientCertificate) => {
            ...
            saveABSFileToOpen(
                `${t("MITMFormAdvancedConfiguration.certificateFileName", {CerName: item.CerName})}`,
        ...
        const onClose = useMemoizedFn((jumpPage?: boolean) => {
            ...
            if (!isEqual(oldValue, newValue)) {
                Modal.confirm({
                    ...
                    content: t("MITMFormAdvancedConfiguration.saveAdvancedConfigConfirm"),
            ...
            >
                <Form labelCol={{span: 6}} wrapperCol={{span: 18}} form={form}>
                    <Form.Item
                        ...
                        name='dnsServers'
                        help={t("MITMFormAdvancedConfiguration.customDNSServer")}
                    ...
                    >
                        <YakitSelect
                            ...
                            allowClear
                            mode='tags'
                            placeholder={t("MITMFormAdvancedConfiguration.exampleIP")}
                        />
                    </Form.Item>
                    ...
                    {enableGMTLS && (
                        <>
                            <Form.Item
                                label={t("MITMFormAdvancedConfiguration.gmTLSPriority")}
                                name='preferGMTLS'
                                help={t("MITMFormAdvancedConfiguration.gmTLSPriorityTip")}
                            ...
                            <Form.Item
                                ...
                                help={t("MITMFormAdvancedConfiguration.gmTLSOnlyTip")}
                                valuePropName='checked'
                            >
                                <YakitSwitch size='large' />
                            </Form.Item>
                    ...
                    <Form.Item
                        label={t("MITMFormAdvancedConfiguration.proxyAuthentication")}
                        name='enableProxyAuth'
                        help={t("MITMFormAdvancedConfiguration.hijackProxyAuthTip")}
                        valuePropName='checked'
                    >
                        <YakitSwitch size='large' />
                    </Form.Item>
                    ...
                    <Form.Item
                        label={t("MITMFormAdvancedConfiguration.disableHomePage")}
                        name='disableCACertPage'
                        valuePropName='checked'
                        help={t("MITMFormAdvancedConfiguration.disableHomePageTip")}
                    >
                        <YakitSwitch size='large' />
                    </Form.Item>
                    <Form.Item
                    ...
                    <Form.Item
                        label={t("MITMFormAdvancedConfiguration.pluginConcurrentProcesses")}
                    ...
                    >
                        ...
                        <div className={styles["drawer-TLS-help"]}>
                            {t("MITMFormAdvancedConfiguration.clientTLSImportTip")}
                        </div>
                        ...
                        <div>
                            <YakitButton type='text' style={{paddingLeft: 0}} onClick={() => setFiltersVisible(true)}>
                                {t("MITMFormAdvancedConfiguration.filter")}
                            </YakitButton>
                            <Divider type='vertical' style={{margin: "0 4px"}} />
