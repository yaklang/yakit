...
import type { CaCertData } from '../MITMServerHijacking/MITMServerHijacking'
        ...
        extra={
          isGMState ? (
            ...
            >
              ...
              <QuestionMarkCircleOutlined className={styles['certificate-download-modal-icon']} color="currentColor" />
            </YakitButton>
          ) : null
        }
      >
