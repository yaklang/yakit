...
const t = i18n.getFixedT(null, "risk")
/** QueryRisks */
export const apiQueryRisks: (query?: QueryRisksRequest) => Promise<QueryRisksResponse> = (query) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.queryFailed", {error: String(e)}))
                reject(e)
            })
    })
}
    ...
    return new Promise((resolve, reject) => {
        ...
        ipcRenderer
            ...
            .catch((e) => {
                yakitNotify(
                    "error",
                    t("RiskTable.queryRisksTotalByRuntimeIdFailed", {error: String(e)})
                )
                reject(e)
            })
    })
    ...
    return new Promise((resolve, reject) => {
        ...
        ipcRenderer
            ...
            .catch((e) => {
                yakitNotify(
                    "error",
                    t("RiskTable.queryRisksTotalByRuntimeIdsFailed", {error: String(e)})
                )
                reject(e)
            })
    })
...
export const apiNewRiskRead: (query?: NewRiskReadRequest) => Promise<null> = (query) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.markReadFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const apiDeleteRisk: (query?: DeleteRiskRequest) => Promise<null> = (query) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.deleteFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const apiExportHtml: (params: ExportHtmlProps) => Promise<string> = (params) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.exportFailed", {error: String(e)}))
                reject(e)
            })
    })
}
    ...
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .catch((e) => {
                yakitNotify(
                    "error",
                    t("RiskTable.queryRiskTagsFailed", {error: String(e)})
                )
                reject(e)
            })
    })
...
export const apiSetTagForRisk: (params: SetTagForRiskRequest) => Promise<SetTagForRiskRequest> = (params) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.settingFailed", {error: String(e)}))
                reject(e)
            })
    })
}
...
export const apiRiskFeedbackToOnline: (params: UploadRiskToOnlineRequest) => Promise<unknown> = (params) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .then(resolve)
            .catch((e) => {
                yakitNotify("error", t("RiskTable.feedbackFailed", {error: String(e)}))
                reject(e)
            })
    })
}
