    ...
    >
      ...
      <div className={styles['horizontal-scroll-card-list-item-info-multiple-infos']}>
        {info.map((ele) => (
          ...
          >
            <div
              className={classNames(styles['horizontal-scroll-card-list-item-info-multiple-infos-item-data'], {
            ...
            <div className={styles['horizontal-scroll-card-list-item-info-multiple-infos-item-id']}>{ele.Id}</div>
          </div>
        ))}
      </div>
    </div>
  ...
  (props) => {
    ...
    return (
      ...
      >
        {compact ? (
          <>
            <div className={styles['horizontal-scroll-card-list-item-info-single-id']} title={tag || item.Id}>
              {tag || item.Id}
            </div>
            <div
