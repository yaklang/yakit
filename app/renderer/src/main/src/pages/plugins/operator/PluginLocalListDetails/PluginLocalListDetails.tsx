 ...
 */
export const PluginLocalListDetails: React.FC<PluginLocalListDetailsProps> = React.memo((props) => {
    const {refreshList = true, children, pluginDetailsProps = {}, hidden} = props
    ...
    const [selectList, setSelectList] = useControllableValue<YakScript[]>(props, {
        defaultValue:[],
