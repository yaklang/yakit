...
const NewShell: React.FC<NewShellProp> = (props) => {
    ...
    const [shell_type, setShellType] = useState("behidner");
...
export const WebShellTable: React.FC<WebShellTableProp> = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, i: WebShell) => i?.ShellType,
            filterIcon: (filtered) => {
                return params && <SearchOutlined style={{color: filtered ? "#1890ff" : undefined}}/>
            },
            filterDropdown: ({setSelectedKeys, selectedKeys, confirm}) => {
        ...
        //     }
        // },
        // {title: "Token", dataIndex: "ReverseToken", render: (_, i: WebShell) => i?.ReverseToken || "-"},
        {
            title: "发现时间",
            dataIndex: "CreatedAt",
