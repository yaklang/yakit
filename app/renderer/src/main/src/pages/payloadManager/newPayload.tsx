    ...
    useEffect(() => {
        ...
        ipcRenderer.on(`${token}-error`, (e: any, error: any) => {
            if (error === `group[${group || dictionariesName}] exist`) {
                ...
                warn(t("CreateDictionaries.dictionaryNameDuplicate"))
                return
            }
        ...
        (fileList: any[]) => {
            ...
            fileList.forEach((f) => {
                if (uploadType === "large-dragger" && !"text/plain".includes(f.type) && f.size / 1024 / 1024 > 20) {
                    failed(t("CreateDictionaries.largeFileStorageTxtOnly"))
                    return false
                }
                if (uploadType === "dragger" && !FileType.includes(f.type)) {
                    failed(t("CreateDictionaries.invalidFileFormat", {name: f.name}))
                    return false
                }
                if (uploadList.map((item) => item.path).includes(f.path)) {
                    warn(t("CreateDictionaries.pathSelected", {path: f.path}))
                    return
                }
                    ...
                    {isDictionaries && (
                        <div className={styles["explain"]}>
                            <div className={styles["explain-bg"]}>
                                <div className={styles["title"]}>{t("CreateDictionaries.chooseStorageMethodTip")}</div>
                                <div className={styles["content"]}>
                                    <div className={styles["item"]}>
                                        <div className={styles["dot"]}>1</div>
                                        <Trans
                                            i18nKey='CreateDictionaries.file_storage_tip'
                                            ns='payload'
                                            components={{
                                                highlight: <span className={styles["hight-text"]} />
                                            }}
                                        />
                                    </div>
                                    <div className={styles["item"]}>
                                        ...
                                        <Trans
                                            i18nKey='CreateDictionaries.db_storage_tip'
                                            ns='payload'
                                            components={{
                                                highlight: <span className={styles["hight-text"]} />
                                            }}
                                    ...
                                    <div className={styles["item"]}>
                                        ...
                                        <Trans
                                            i18nKey='CreateDictionaries.large_file_storage_tip'
                                            ns='payload'
                                            components={{
                                                size: <span className={styles["hight-text"]} />,
                                                highlight: <span className={styles["hight-text"]} />
                                            }}
                                        />
                                    </div>
                            ...
                            <div className={styles["card-heard"]}>
                                <YakitRadioButtons
                                    ...
                                    options={[
                                        ...
                                        {
                                            value: "large-dragger",
                                            label: t("CreateDictionaries.uploadLargeFile")
                                        }
                                    ]}
                                    // size={"small"}
                                />
                                    ...
                                    <div className={styles["upload-dragger-box"]}>
                                        ...
                                        >
                                            <div className={styles["upload-info"]}>
                                                ...
                                                <div className={styles["content"]}>
                                                    <Trans
                                                        i18nKey='CreateDictionaries.file_drag_tip'
                                                        ns='payload'
                                                        components={{
                                                            highlight: <span className={styles["hight-light"]} />
                                                        }}
                                                    />
                                                    <div className={styles["sub-title"]}>
                                                        {uploadType === "dragger"
                                                            ? t("CreateDictionaries.batchFolderUploadTip")
                                                            : t("CreateDictionaries.largeFileUploadTip")}
                                                    </div>
                                                </div>
                                            </div>
                                        </Dragger>
                ...
                <UploadStatusInfo
                    title={
                        storeType === "database"
                            ...
                            : t("CreateDictionaries.autoDedupCheck")
                    }
...
export const NewPayloadLocalList: React.FC<NewPayloadLocalListProps> = (props) => {
    ...
    const {t, i18n} = useI18nNamespaces(["payload", "yakitUi", "yakitRoute"])
    ...
    const onUpdateAllPayloadGroup = useMemoizedFn((data: DataItem[]) => {
        ...
        if (!isEqual) {
            ipcRenderer
                ...
                .catch((e: any) => {
                    failed(`${t("NewPayloadLocalList.dataUpdateFailed")}${e}`)
                })
        }
    })
                ...
                <div className={styles["header"]}>
                    <div className={styles["title-box"]}>
                        <div className={styles["title"]}>
                            {onlyInsert ? t("NewPayloadLocalList.selectDictionaryToInsert") : t("YakitRoute.Payload")}
                        </div>
                    ...
                    <div className={styles["extra"]}>
                        {onlyInsert ? (
                            <>
                                <Tooltip
                                    title={t("NewPayloadLocalList.goToDictionaryManagement", {
                                        Payload: t("YakitRoute.Payload")
                                    })}
                                >
                                    <YakitButton
                                        type='text2'
                                    ...
                                    <YakitButton
                                        ...
                                        onClick={() => {
                                            if (exportData.length === 0) {
                                                warn(t("NewPayloadLocalList.selectExportContent"))
                                                return
                                            }
                                            setExportType("all")
                                                ...
                                                label: (
                                                    <div className={styles["extra-menu"]}>
                                                        ...
                                                        <div className={styles["menu-name"]}>
                                                            {t("NewPayloadLocalList.createNewDictionary")}
                                                        </div>
                                                    </div>
                                                )
                                            },
                                            {
                                                ...
                                                label: (
                                                    <div className={styles["extra-menu"]}>
                                                        <OutlineFolderaddIcon />
                                                        <div className={styles["menu-name"]}>
                                                            {t("NewPayloadLocalList.createNewFolder")}
                                                        </div>
                                                    </div>
                                                )
                                            }
                                            ...
                                            switch (key) {
                                                case "createDictionaries":
                                                    const m = showYakitModal({
                                                        ...
                                                        content: (
                                                            <CreateDictionaries
                                                                title={t("NewPayloadLocalList.createNewDictionary")}
                                                                type='dictionaries'
        ...
        if (inputName.length > 0 && !allFolderName.includes(inputName) && pass) {
            ...
            if (folder.isCreate) {
                ipcRenderer
                    ...
                    .catch((e: any) => {
                        failed(`${t("FolderComponent.createFolderFailed")}${e}`)
            ...
            // 编辑
                ...
                ipcRenderer
                    ...
                    .then(() => {
                        success(t("YakitNotification.updated"))
                        setInputName(inputName)
                        setFolderNameById()
                    })
                    .catch((e: any) => {
                        setInputName(folder.name)
                        failed(`${t("YakitNotification.updateFailed", {colon: true})}${e}`)
                    })
            }
        } else {
            !pass && warn(t("FolderComponent.invalidNameCharacters"))
            // 创建时为空则不创建
            if (folder.isCreate) {
                setData(data.filter((item) => !item.isCreate))
                allFolderName.includes(inputName) &&
                    inputName.length !== 0 &&
                    warn(t("FolderComponent.folderNameDuplicate"))
            }
            // 编辑时为空恢复
            else {
                // 没有修改
                ...
                folder.name !== inputName &&
                    allFolderName.includes(inputName) &&
                    warn(t("FolderComponent.folderNameDuplicateEdit"))
            }
        }
    })
                                            ...
                                            },
                                            {
                                                ...
                                                label: (
                                                    <div className={styles["extra-menu"]}>
                                                        <OutlineAddPayloadIcon />
                                                        <div className={styles["menu-name"]}>
                                                            {t("FolderComponent.addSubsetDictionary")}
                                                        </div>
                                                    </div>
                                                )
                                            },
                                            ...
                                            switch (key) {
                                                ...
                                                case "addChildPayload":
                                                    ...
                                                    const m = showYakitModal({
                                                        ...
                                                        content: (
                                                            <CreateDictionaries
                                                                title={t("FolderComponent.createSubsetDictionary")}
                                                                type='dictionaries'
                                                                onQueryGroup={onQueryGroup}
                                                                folder={folder.name}
                                                                onClose={() => {
    ...
    return (
        <>
            ...
            <YakitHint
                ...
                title={t("DeleteConfirm.confirmDelete")}
                content={t("DeleteConfirm.confirmDeleteTip")}
                footerExtra={
...
export const FileComponent: React.FC<FileComponentProps> = (props) => {
    ...
    const onChangeValue = useMemoizedFn(() => {
        ...
        if (inputName.length > 0 && !allFileName.includes(inputName) && pass) {
            ...
            file.name !== inputName &&
                ...
                warn(t("FileComponent.editFailedNameDuplicate"))
            !pass && warn(t("FileComponent.invalidNameCharacters"))
            setInputName(file.name)
        }
    })
            ...
            ? [
                  {
                      ...
                      label: (
                          <div className={styles["extra-menu"]}>
                              <OutlineDocumentduplicateIcon />
                              <div className={styles["menu-name"]}>{t("FileComponent.copyFuzztag")}</div>
                          </div>
                      )
                  },
                  {
                      ...
                      label: (
                          <div className={styles["extra-menu"]}>
                              <OutlineImportIcon />
                              <div className={styles["menu-name"]}>{t("FileComponent.expandDictionary")}</div>
                          </div>
                      )
                  },
                  {
            ...
            : [
                  ...
                  },
                  {
                      ...
                      label: (
                          <div className={styles["extra-menu"]}>
                              <OutlineDatabasebackupIcon />
                              <div className={styles["menu-name"]}>{t("FileComponent.convertToDatabaseStorage")}</div>
                          </div>
                      )
                  },
                  {
    ...
    }, [userInfo?.isLogin, i18n.language])
    ...
    return (
        <>
                                            ...
                                            switch (key) {
                                                ...
                                                case "importPayload":
                                                    const m = showYakitModal({
                                                        ...
                                                        content: (
                                                            <CreateDictionaries
                                                                title={`${t("FileComponent.expandTo")} ${inputName}`}
                                                                type='payload'
                                                                onQueryGroup={onQueryGroup}
                                                                folder={folder}
                                                                group={inputName}
            ...
            >
                <UploadStatusInfo
                    title={t("FileComponent.convertingToDatabaseStorage")}
                    streamData={streamData}
                    cancelRun={() => {
...
export const MoveOrCopyPayload: React.FC<MoveOrCopyPayloadProps> = (props) => {
    ...
    useEffect(() => {
        ipcRenderer
            ...
            .catch((e: any) => {
                failed(`${t("MoveOrCopyPayload.getDataFailed")}${e}`)
            })
            .finally()
    }, [])
    return (
...
export const PayloadLocalContent: React.FC<PayloadLocalContentProps> = (props) => {
    ...
    const onQueryEditor = useMemoizedFn((Group: string, Folder: string) => {
        ...
        ipcRenderer
            ...
            .catch((e: any) => {
                failed(t("PayloadLocalContent.editorDataFetchFailed"))
            })
            .finally(() => {
                setLoading(false)
            })
        ...
        return new Promise((resolve, reject) => {
            if (copyMoveValueRef.current === undefined) {
                ...
                ipcRenderer
                    ...
                    .catch((e: any) => {
                        failed(`${t("PayloadLocalContent.dictionaryOperationFailed")}${e}`)
                        resolve(false)
                    })
                    .finally()
            }
    ...
    const onCopyToOtherPayload = useMemoizedFn((id?: number) => {
        ...
        const m = showYakitModal({
            title: t("PayloadLocalContent.backupToOtherDictionary"),
            width: 400,
            type: "white",
            closable: false,
    ...
    const onMoveToOtherPayload = useMemoizedFn((id?: number) => {
        ...
        const y = showYakitModal({
            title: t("PayloadLocalContent.moveToOtherDictionary"),
            width: 400,
            type: "white",
            closable: false,
            content: <MoveOrCopyPayload copyMoveValueRef={copyMoveValueRef} group={group} />,
    ...
    return (
        <div className={styles["payload-content"]}>
                ...
                <div className={styles["title-box"]}>
                    ...
                    <div className={styles["sub-title"]}>
                        {showContentType === "editor" && payloadFileData?.IsBigFile ? (
                            <YakitTag color='danger'>{t("PayloadLocalContent.extraLargeDictionary")}</YakitTag>
                    ...
                    <div className={styles["extra"]}>
                        ...
                        {!isNoSelect && size && (
                            <>
                                {size.width < 950 ? (
                                    <>
                                        <Tooltip title={t("PayloadLocalContent.backupToOtherDictionary")}>
                                            <YakitButton
                                                type='outline2'
                                        ...
                                        <Tooltip title={t("PayloadLocalContent.moveToOtherDictionary")}>
                                            <YakitButton
                                                type='outline2'
                                    ...
                                    <>
                                        <YakitButton
                                            ...
                                            onClick={() => onCopyToOtherPayload()}
                                        >
                                            {t("PayloadLocalContent.backupToOtherDictionary")}
                                        </YakitButton>
                                        <YakitButton
                                            type='outline2'
                                            icon={<OutlineClipboardcopyIcon />}
                                            onClick={() => onMoveToOtherPayload()}
                                        >
                                            {t("PayloadLocalContent.moveToOtherDictionary")}
                                        </YakitButton>
                                    </>
                                )}
                            </>
                        ...
                        <YakitButton
                            ...
                            onClick={() => {
                                const m = showYakitModal({
                                    ...
                                    content: (
                                        <CreateDictionaries
                                            title={`${t("PayloadLocalContent.expandTo")} ${group}`}
                                            type='payload'
                                            onQueryGroup={() => {
                                                emiter.emit("refreshListEvent")
                                            }}
                        ...
                        >
                            ...
                            {payloadFileData?.IsBigFile === false && (
                                <>
                                    ...
                                    >
                                        {t("PayloadLocalContent.autoDeduplicate")}
                                    </YakitButton>
            ...
            >
                <UploadStatusInfo
                    title={t("PayloadLocalContent.autoDeduplicating")}
                    streamData={streamData}
                    cancelRun={() => {
                        cancelRemoveDuplicate()
                        setVisible(false)
...
export const PayloadOnlineContent: React.FC<PayloadLocalContentProps> = (props) => {
    ...
    const onQueryEditor = useMemoizedFn((Group: string, Folder: string) => {
        ...
        apiGetOnlinePayloadFile({group: Group, folder: Folder})
            ...
            .catch((e: any) => {
                failed(`${t("PayloadOnlineContent.editorDataFetchFailed")}${e}`)
            })
            .finally(() => {
                setLoading(false)
            })
        ...
        <div className={styles["payload-content"]}>
            <div className={styles["header"]}>
                <div className={styles["title-box"]}>
                    ...
                    <div className={styles["sub-title"]}>
                        {showContentType === "editor" && payloadFileData?.IsBigFile ? (
                            <YakitTag color='danger'>{t("PayloadOnlineContent.extraLargeDictionary")}</YakitTag>
                        ) : selectPayloadArr.length > 0 ? (
                            <div className={styles["total-item"]}>
                                <span className={styles["total-item-text"]}>Selected</span>
                                <span className={styles["total-item-number"]}>{selectPayloadArr?.length}</span>
                            ...
                            t("PayloadOnlineContent.fuzzModuleRenderTip")
                        )}
                    </div>
                </div>
                {showContentType === "table" && (
...
export const ExportByPayloadGrpc: React.FC<ExportByPayloadGrpcProps> = (props) => {
    ...
    return (
        ...
        >
            <UploadStatusInfo
                title={t("ExportByPayloadGrpc.exporting")}
...
export const UploadOrDownloadByPayloadGrpc: React.FC<UploadOrDownloadByPayloadGrpcProps> = (props) => {
    ...
    return (
        ...
        >
            <UploadStatusInfo
                title={`${t("UploadOrDownloadByPayloadGrpc.updating", {
                    value: type === "upload" ? t("YakitButton.upload") : t("YakitButton.download")
                })}`}
                streamData={exportStreamData}
                cancelRun={() => {
                    cancelExportFile()
...
export const NewPayload: React.FC<NewPayloadProps> = (props) => {
    ...
    const onQueryGroup = (obj?: {Group: string; Folder: string}) => {
        ...
        ipcRenderer
            ...
            .catch((e: any) => {
                failed(`${t("NewPayload.getDictionaryListFailed")}${e}`)
            })
            .finally(() => {
                setTimeout(() => {
    ...
    return (
        <div className={styles["new-payload"]} id='new-payload'>
            ...
            {data.length === 0 ? (
                <div className={styles["no-data"]}>
                    <YakitEmpty
                        ...
                        children={
                            ...
                            >
                                {t("NewPayload.createNewDictionary")}
                            </YakitButton>
                        }
                    />
                </div>
                ...
                <>
                    {showContentType ? (
                        ...
                        <div className={styles["no-data"]}>
                            <YakitEmpty title={t("NewPayload.noPayloadDictionary")} />
                        </div>
                    )}
                </>
            )}
            <YakitHint
                ...
                content={t("NewPayload.payloadMigrationTip", {Payload: t("YakitRoute.Payload")})}
                footer={
            ...
            <YakitHint
                ...
                content={t("NewPayload.engineVersionTooLowTip", {Payload: t("YakitRoute.Payload")})}
                footer={
                    <div style={{marginTop: 24, textAlign: "right"}}>
                        <YakitButton
                            size='max'
            ...
            >
                <UploadStatusInfo
                    title={t("NewPayload.migratingData")}
                    streamData={streamData}
                    cancelRun={() => {
