    ...
    return (
      <>
        {queryParams?.rate?.map((item) => {
          return (
            <Tooltip title={item.label} placement="top" key={item.id} rootClassName="plugins-tooltip">
        ...
        {queryParams?.tags?.map((item) => {
          return (
            <Tooltip title={item.Value} placement="top" key={item.Value} rootClassName="plugins-tooltip">
