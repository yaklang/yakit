                      ...
                      <>
                        <Form.Item label="启用公网穿透">
                          <YakitSwitch
                            ...
                            onChange={(IsRemote) => setAddrParams({ ...addrParams, IsRemote })}
                          />
                        </Form.Item>
            ...
            return (
              <Form.Item
                ...
                rules={[
                  ...
                  () => ({
                    validator(_, value) {
                      if (item.Type === FormParamsType.StringBool || item.Type === FormParamsType.StringPort)
              ...
              >
                {(item.Type === FormParamsType.String || item.Type === FormParamsType.Base64Bytes) && (
                  <YakitInput
                    allowClear
                    placeholder={
                      item.Type === FormParamsType.Base64Bytes ? '填写内容需Base64编码' : `请输入${item.KeyVerbose}`
                    }
      ...
      extra={
        width < 510 || (isMin && !codeExtra) ? (
          ...
          <div className="extra-btns">
            ...
            {type === 'hex' ? (
              <YakitButton loading={loading} type="primary" size="small" onClick={() => codeOperate('download')}>
                下载文件
              </YakitButton>
            ) : (
              <></>
