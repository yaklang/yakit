          ...
          <YakitSpin spinning={initLoading.current && loading}>
            <div ref={wrapperRef} className={styles['table-body']} onScroll={handleScroll}>
              <div ref={bodyRef}>
                {list.map((item) => {
                  const { data } = item
                  const { FrameIndex, FromServer, IsJson, IsProtobuf, DataVerbose, cellClassName } = data
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ width: 100 }} className={classNames(styles['tr-cell'], styles['base-cell'])}>
                        {FromServer ? (
                      ...
                      <div style={{ width: 97 }} className={classNames(styles['tr-cell'], styles['base-cell'])}>
                        {IsJson && <YakitTag className={styles['cell-tag-style']}>Json</YakitTag>}
                        {IsProtobuf && <YakitTag className={styles['cell-tag-style']}>Protobuf</YakitTag>}
                      </div>
                      <div className={classNames(styles['tr-cell'], styles['base-cell'], styles['flex-cell'])}>
                        <span
                          style={{
                            color: onlyRed ? 'var(--Colors-Use-Basic-Background)' : undefined,
                          }}
                          className={classNames(styles['cell-data-verbose'], 'yakit-content-single-ellipsis')}
                          title={DataVerbose}
                        >
                          {DataVerbose}
                        </span>
                      </div>
                      <div style={{ width: 63 }} className={classNames(styles['tr-cell'], styles['base-cell'])}>
                        <YakitButton
                          type="text"
                          size="small"
                          onClick={() => {
