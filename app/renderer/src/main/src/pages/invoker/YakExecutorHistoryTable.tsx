    ...
    return (
        <Row style={{ width: "100%" }}>
            <Space direction={"vertical"} style={{ width: "100%" }}>
                ...
                <Tabs>
                    {r.Stderr && (
                        <Tabs.TabPane tab={"标准错误流内容"} key={"stderr"}>
                    ...
                    {r.Stdout && (
                        <Tabs.TabPane tab={"标准输出流内容"} key={"stdout"}>
                            <div style={{ height: 300 }}>
                    ...
                    props.mini
                        ...
                        : [
                              ...
                              },
                              {
                                  title: "状态",
                                  render: (r: ExecHistoryRecord) =>
                                      r.Ok ? <Tag color={"green"}>执行成功</Tag> : <Tag>执行失败</Tag>
                              },
                              {
                                  title: "执行间隔(ms)",
                                  render: (r: ExecHistoryRecord) => <Tag color={"geekblue"}>{r.DurationMs}ms</Tag>
                              },
                              {
                                  ...
                                  render: (r: ExecHistoryRecord) =>
                                      r.Ok ? (
                                          <Space>
                                              {r.Stdout && (
                                                  <Tag color={"geekblue"}>标准输出内容长度[{r.StdoutLen}]</Tag>
                                              )}
