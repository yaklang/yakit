...
const ConcurrentStreamContent: FC<ConcurrentStreamContentProps> = memo(({ childrenTokens, scrollContainerRef }) => {
  ...
  return (
    <div className={styles['content']} hidden={childrenTokens.length === 0}>
      <div
        ref={scrollRef}
