...
import { AISourceEnum, type AIStartParams } from '@/pages/ai-re-act/hooks/grpcApi'
...
export const AIForgeForm: React.FC<AIForgeFormProps> = memo((props) => {
  ...
  return (
    <div style={{ maxHeight: wrapperSize ? (wrapperSize.height || 0) - 60 : 240 }} className={styles['ai-forge-form']}>
