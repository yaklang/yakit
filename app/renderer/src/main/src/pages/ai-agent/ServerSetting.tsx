...
import { RenderMCPClientInfo, ServerChatInfo, ServerChatProps, ServerSettingProps} from "./aiAgentType"
...
export const ServerSetting: React.FC<ServerSettingProps> = memo((props) => {
    ...
    const {setMCPServers} = useDispatcher()
        ...
        getRemoteValue(RemoteAIAgentGV.MCPClientList)
            .then((res) => {
                ...
                try {
                    ...
                    const {setMCPServers} = useDispatcher()((old) => {
