...
export const AIChatTextarea: React.FC<AIChatTextareaProps> = memo((props) => {
    const {extraFooter, onSubmit, textareaProps} = props
                ...
                <div className={styles["textarea-icon"]}>
                    ...
                    <svg xmlns='http://www.w3.org/2000/svg' width='17' height='16' viewBox='0 0 17 16' fill='none'>
                        <path
                            ...
                            stroke='url(#paint0_linear_42473_38280)'
                            strokeLinecap='round'
                            strokeLinejoin='round'
                        />
                        <defs>
                            <linearGradient
                                id='paint0_linear_42473_38280'
                                x1='2.5'
                                y1='2'
                                x2='16.8935'
                                y2='6.75561'
                            ...
                            >
                                ...
                                <stop offset='0.639423' stop-color='#8862F8' />
                                <stop offset='1' stop-color='#4493FF' />
                            </linearGradient>
                        </defs>
                    </svg>
                </div>
