        ...
        {isSimpleDetect && (
          <>
            <Form.Item label={t('ScanPortForm.presetPort')} name="presetPort">
              <Checkbox.Group className={styles['preset-port-group-wrapper']} onChange={onCheckPresetPort}>
  ...
  return (
    <>
      ...
      >
        ...
        {saveToDB && (
          <>
            <Form.Item label={t('ScanPortForm.saveClosedPorts')} name="SaveClosedPorts" valuePropName="checked">
              <YakitSwitch />
            </Form.Item>
          </>
        )}
