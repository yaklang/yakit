...
/** @name 更新指纹里的本地组 */
export const grpcUpdateFingerprintToGroup: APIFunc<BatchUpdateFingerprintToGroupRequest, unknown> = (request) => {
    return new Promise(async (resolve, reject) => {
        ipcRenderer
...
/** @name 下载默认指纹压缩包 */
export const httpDownloadFingerprint: APIFunc<string, unknown> = (savePath) => {
    return new Promise(async (resolve, reject) => {
        ipcRenderer
