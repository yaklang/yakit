    ...
    <>
        ...
        <div className={styles['notepad-content']}>
          <div className={styles['notepad-heard']}>
            ...
            <div className={styles['notepad-heard-subTitle']}>
              <span>
                {t('NotepadLocalList.lastUpdateTime')}:{formatTimestamp(note?.UpdateAt)}
              </span>
            </div>
          </div>
      ...
      {exportVisible && (
        <NotepadExport
          ...
          getContainer={document.getElementById(`main-operator-page-body-${YakitRoute.Modify_Notepad}`) || undefined}
        />
      )}
    </>
  )
