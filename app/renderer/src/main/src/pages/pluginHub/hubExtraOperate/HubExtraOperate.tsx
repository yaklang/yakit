        ...
        const menuData = useMemo(() => {
            ...
            if (isCorePlugin) {
                const menus: YakitMenuItemType[] = [
                    ...
                    {
                        key: "export",
                        label: t("HubExtraOperate.export"),
            ...
            <div className={styles["hub-extra-operate"]}>
                ...
                {!isCorePlugin && (
                    <HubButton
                        ...
                        name={isUpdate ? t("HubExtraOperate.update") : t("HubExtraOperate.download")}
