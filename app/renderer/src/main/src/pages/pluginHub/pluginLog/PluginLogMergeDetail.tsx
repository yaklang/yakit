        ...
        <>
            ...
            >
                <Form form={noPassForm}>
                    <Form.Item label='' name='noPassReason' rules={[{required: true, message: t("PluginLogMergeDetail.noMergeReasonRequired")}]}>
                        <YakitInput.TextArea
        ...
        return (
            <Form className={styles["plugin-base-info-form"]} form={form} layout='vertical'>
                <Form.Item
                    label={
                        <>
                                {t("PluginLogMergeDetail.scriptType")}<span className='form-item-required'>*</span>:
                        </>
                    }
                    name='Type'
                ...
                <Form.Item
                    label={
                        <>
                                {t("PluginLogMergeDetail.pluginName")}<span className='form-item-required'>*</span>:
                        </>
                    }
                    name='ScriptName'
                    required={true}
                    rules={[
                        {
                            validator: async (_, value) => {
                                if (!value || !value.trim()) return Promise.reject(new Error(t("PluginLogMergeDetail.pluginNameRequired")))
                ...
                >
                    <YakitInput
                        ...
                        placeholder={t("PluginLogMergeDetail.pleaseEnter")}
                        size='large'
                ...
                {EnablePluginSelector && (
                    <Form.Item
                        ...
                        label={
                            <>
                                {t("PluginLogMergeDetail.linkedPluginType")}<span className='form-item-required'>*</span>:
                            </>
                        }
                        required={true}
                    ...
                    >
                        ...
                        >
                            ...
                            <YakitSelect.Option value='port-scan'>{t("PluginLogMergeDetail.portScan")}</YakitSelect.Option>
                        </YakitSelect>
                    </Form.Item>
                )}
            </Form>
...
export const PluginLogCodeDiff: React.FC<PluginLogCodeDiffProps> = memo((props) => {
    ...
    return (
        <YakitModal
            ...
            keyboard={false}
            width='75%'
                            cancelText={t("PluginLogMergeDetail.close")}
            onCancel={onCancel}
            okButtonProps={{style: {display: "none"}}}
        >
