    ...
    const sendToFuzzer = (isHttps: boolean, request: string) => {
        ...
        setFuzzers([
            ...fuzzers,
            {
                verbose,
                key: newFuzzerId,
                node: <HTTPFuzzerPage isHttps={isHttps} request={request} />
            }
        ])
        ...
        <div style={{ margin: 0, height: "100%" }}>
            <Spin spinning={loading} style={{ height: "100%" }}>
                <Tabs
                    ...
                    addIcon={
                        <div style={{ cursor: "pointer", padding: "0 5px", color: "rgb(23,145,255" }}>
                            <PlusOutlined />
                            创建 Web Fuzzer
                        </div>
                    }
                >
                    ...
                    <Tabs.TabPane tab={"网站树视角"} key={"website-tree"} closable={false}>
                        <WebsiteTreeViewer onSendToWebFuzzer={sendToFuzzer} />
                    </Tabs.TabPane>
                    {fuzzers.map((i) => (
                        <Tabs.TabPane
                            tab={i.verbose}
