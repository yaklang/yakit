...
import { HistoryOperatorDemo } from "@/components/playground/historyOperator/HistoryOperatorDemo"
            ...
            <AutoCard
                title={
                    <DemoItemSelectOne
                        label={"调试组件"}
                        data={[
                            {value: "history-operator", label: "History操作台"},
