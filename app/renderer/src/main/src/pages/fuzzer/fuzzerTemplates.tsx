...
export const encodeOperators: FuzzOperatorItem[] = [
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        ...
        tag={'upper'}
        help={i18n.t('FuzzerTemplates.convert_tag_content_to_uppercase', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'upper',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'lower'}
        help={i18n.t('FuzzerTemplates.convert_tag_content_to_lowercase', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'lower',
  },
  ...
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'base64enc'}
        help={i18n.t('FuzzerTemplates.base64_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'base64enc',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'base64dec'}
        help={i18n.t('FuzzerTemplates.base64_decode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'base64dec',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'hex'}
        help={i18n.t('FuzzerTemplates.convert_tag_content_to_hex_encoding', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'hex',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'hexdec'}
        help={i18n.t('FuzzerTemplates.decode_tag_content_from_hex', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'hexdec',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'sha1'}
        help={i18n.t('FuzzerTemplates.calculate_sha1_of_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'sha1',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'sha256'}
        help={i18n.t('FuzzerTemplates.calculate_sha256_of_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'sha256',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'sha512'}
        help={i18n.t('FuzzerTemplates.calculate_sha512_of_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'sha512',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'urlenc'}
        help={i18n.t('FuzzerTemplates.url_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'urlenc',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'urldec'}
        help={i18n.t('FuzzerTemplates.url_decode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'urldec',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'doubleurlenc'}
        help={i18n.t('FuzzerTemplates.double_url_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'doubleurlenc',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'doubleurldec'}
        help={i18n.t('FuzzerTemplates.double_url_decode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'doubleurldec',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'html'}
        help={i18n.t('FuzzerTemplates.html_xxxx_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'html',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'htmlhex'}
        help={i18n.t('FuzzerTemplates.html_xaaaa_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'htmlhex',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'htmldec'}
        help={i18n.t('FuzzerTemplates.html_xxxx_decode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
    tag: 'htmldec',
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'ascii'}
        help={i18n.t('FuzzerTemplates.ascii_encode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
  },
  {
    ...
    optionsRender: (s, callback) => (
      <EncodeTag
        {...{ origin: s, setOrigin: callback }}
        tag={'asciidec'}
        help={i18n.t('FuzzerTemplates.ascii_decode_tag_content', { ns: 'webFuzzer' })}
      />
    ),
  },
]
