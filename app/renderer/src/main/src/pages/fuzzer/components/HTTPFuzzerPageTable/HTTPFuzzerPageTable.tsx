                    ...
                    for (let index = 0; index < l; index++) {
                        ...
                        if (query?.Color && query?.Color?.length > 0) {
                            ...
                            for (let index = 0; index < cLength.length; index++) {
                                ...
                                console.log("record", record.HitColor, query.Color,record.HitColor.toUpperCase().indexOf(element))
                                if (record.MatchedByMatcher && record.HitColor.toUpperCase().indexOf(element) > -1) {
