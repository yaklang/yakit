...
import {MacUIOpCloseSvgIcon, MacUIOpMaxSvgIcon, MacUIOpMinSvgIcon, MacUIOpRestoreSvgIcon} from "@/assets/newIcon"
import {ipcEventPre} from "@/utils/ipcEventPre"
import styles from "./MacUIOp.module.scss"

const {ipcRenderer} = window.require("electron")

interface MacUIOpProp {}
export const MacUIOp: React.FC<MacUIOpProp> = React.memo((props) => {
    ...
    useEffect(() => {
        ipcRenderer.invoke(`${ipcEventPre}is-full-screen`)
