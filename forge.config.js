...
const productConfigs = {
  irify: {
    ...
    icon: 'app/assets/yakitsslogo',
    rpmIcon: 'app/assets/yakitsslogo.ico',
    ignore: [/^\/app\/assets\/(?!irify-close\.png$|yakitsslogo.*|yakitlogo\.png$|导入模板\.xlsx$).*$/],
    version: '1.2.2-alpha.424',
  },
  memfit: {
    name: 'MemfitAI',
