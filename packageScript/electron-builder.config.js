...
const configOption = {
  ...
  // Include runtime artifacts explicitly; source trees and migration tooling stay outside app.asar.
  files: [
    'package.json',
    'dist/electron/**/*',
    'app/renderer/pages/**/*',
    'app/renderer/engine-link-startup/dist/**/*',
    'app/renderer/electron/**/*',
    ...(files || []),
    '!dist/electron/**/*.map',
    '!**/yakit-e2e-build.json',
  ],
  asar: true,
  asarUnpack: ['dist/electron/resources/native/**/*', 'dist/electron/resources/libs/extVendor/**/*'],
  publish: [
    {
      provider: 'generic',
