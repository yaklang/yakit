...
echo "Start to download linkirify render: ${link_file_name}"
wget -O ${link_file_name} https://oss-qn.yaklang.com/linkirify/render/${LINK_RENDER_VERSION}/${link_file_name} || {
    echo "Error: Download linkirify render Failed" >&2
    exit 1
}
